...
$query1 = "SELECT user_data.fname FROM user_data INNER JOIN user_type ON user_data.id = user_type.user_id 
INNER JOIN access_type ON user_type.access_type_id = accessType.id 
WHERE accessType.Designation = 'Student'";
...
$query ="SELECT standard FROM standard";
